...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var pageOverlay = mainPage.querySelector('.wrapper__overlay');
  var mainHeader = document.querySelector('.main-header');
  var mainNavigation = mainHeader.querySelector('.main-navigation');
  var logoHeader = mainHeader.querySelector('.logo-header');
  var menuToggle = mainHeader.querySelector('.main-navigation__toggle');
  var itemMenu = mainHeader.querySelectorAll('.main-navigation a');
  var mapBlock = mainPage.querySelector('.map');
  ...
  var anchorMenu = document.querySelectorAll('.main-navigation a[href^="#"]');
  ...
  var inputMail = document.querySelector('#user-mail');
  var submitForm = document.querySelector('.booking__form');
  ...
  var cards = document.querySelectorAll('.product-card a');
